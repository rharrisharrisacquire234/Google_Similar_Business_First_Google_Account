...
# -------------------------------------------------
BUSINESS_QUERIES = [
    "Green Wall Installation Service in",
    "Interior Plant Rental Service in",
    "Interior Plant Maintenance Service in",
    "Indoor Plant Care Service in",
    "Office Plant Maintenance Service in",
]
