...
# -------------------------------------------------
BUSINESS_QUERIES = [
    "Access Control System Installer in",
    "Security Access Control Service in",
    "Automatic Gate Installer in",
    "Electric Gate Installation Service in",
    "Gate Automation Service in",
]
