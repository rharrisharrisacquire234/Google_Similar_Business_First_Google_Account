...
# -------------------------------------------------
BUSINESS_QUERIES = [
    "Commercial Fencing Service in",
    "Access Control Fencing Service in",
    "Automated Gate Installation Service in",
    "Fence Repair and Maintenance Service in",
    "Security Fencing Installation Service in",
]
